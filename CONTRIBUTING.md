...
We welcome and appreciate your contributions to beCPG Artworks! Whether it's code, translations, or suggestions, your help is essential for the project's success. Please follow the guidelines below to contribute effectively.
...
2. If you have suggestions, bug reports, or want to discuss improvements, open an [issue](https://github.com/becpg/becpg-artworks/issues). We value all contributions and would love to hear from you.

### Submitting a Pull Request

1. [Fork](https://github.com/becpg/becpg-artworks/fork) and clone the repository.
...
6. Push to your fork and [submit a pull request](https://github.com/becpg/becpg-artworks/compare).
...
- Follow our [style guide](AGENTS.md).
